...
// internal
import { ewoTestimonialsData } from '@/data/testimonial-data';
...
const BeautyTestimonial = () => {
  return (
    <>
      <section className="tp-testimonial-area pt-35 pb-35">
        <div className="container">
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-section-title-wrapper-3 mb-45 text-center">
                <span
                  className="tp-section-title-pre-3"
                  style={{ color: '#ef233c' }}
                >
                  Customers Review
                </span>
